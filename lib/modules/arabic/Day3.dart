...
_Day3State daystate3 = _Day3State();

class Day3 extends StatefulWidget {
  final String txt;

  const Day3({Key? key, required this.txt}) : super(key: key);

  @override
  _Day3State createState() {
    daystate3 = _Day3State();
    return daystate3;
  }
}
                      ...
                      child: Padding(
                        ...
                        child: InkWell(
                            onTap: () {
                              ...
                              HomeCubit.get(context).scoresArabic[2] = score / 3;
