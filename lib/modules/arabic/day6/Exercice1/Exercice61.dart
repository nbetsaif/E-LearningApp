...
class Exercice61 extends StatefulWidget {
  // final int number;
...
class _Exercice31State extends State<Exercice61> {
  bool visible = false;
  double bottom = 0;
  double top = 0;
  @override
  ...
  List<bool> Q2Val = [false, false, false, false, false, false];
  List<bool> Q2sol = [true, true, false, false, true, false];

  List<String> Q4 = [
    'يسقي الطّفل الشّجرة بانتظامِ',
    'ِلا يهتم الطّفل بالشّجرة',
    'يعبث الطّفل بالشجرةُ',
    'الطّفل متعب لذلك لم يعتني بالشّجرة',
  ];
  List<bool> Q4Val = [false, false, false, false];
  List<bool> Q4ValSOL = [false, true, false, true];
