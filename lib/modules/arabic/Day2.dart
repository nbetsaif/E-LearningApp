...
_Day2State daystate2 = _Day2State();

class Day2 extends StatefulWidget {
  final String txt;

  const Day2({Key? key, required this.txt}) : super(key: key);

  @override
  _Day2State createState() {
    daystate2 = _Day2State();
    return daystate2;
  }
}
                      ...
                      child: Padding(
                        ...
                        child: InkWell(
                            onTap: () {
                              ...
                              HomeCubit.get(context).scoresArabic[1] = score / 3;
